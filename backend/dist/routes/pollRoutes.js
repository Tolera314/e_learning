...
router.post('/', (0, authMiddleware_1.authorize)('INSTRUCTOR', 'ADMIN'), pollController.createPoll);
router.get('/session/:sessionId', pollController.getSessionPolls);
router.post('/:pollId/vote', pollController.votePoll);
router.patch('/:pollId/close', (0, authMiddleware_1.authorize)('INSTRUCTOR', 'ADMIN'), pollController.closePoll);
